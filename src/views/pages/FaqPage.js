...
import 'views/pages/RsvpPage';
import 'views/pages/EventPage';
import 'views/pages/TravelPage';
    ...
    return (
        ...
        <div className="Faq">
            ...
            <div className="Faq-text">
                ...
                <p className="Faq-answer"> Please navigate to the <Link to="/rsvp" className="internal-link">RSVP page</Link> and follow the instructions in your invitation. If you are having issues with the RSVP page, please email us with your response at luvandkrishi@gmail.com </p>
                ...
                <p className="Faq-answer"> Let us know! It’ll be sad that you won’t be able to make it, but please submit your response using the <Link to="/rsvp" className="internal-link">RSVP page</Link> so we can plan accordingly. </p>
                <br></br>

                <a id="coronavirus"><h1> coronavirus </h1></a>
                <h3 className="Faq-question"> what coronavirus precautions are in place? </h3>
                <p className="Faq-answer"> Hand sanitizer and masks will be readily available at all functions. We will follow the COVID protocols that are recommended by the CDC at the time of the event. </p>

                <h3 className="Faq-question"> how will changes to the schedule be communicated before the ceremony? </h3>
                <p className="Faq-answer"> We plan to communicate any changes to the schedule through the <Link to="/events" className="internal-link">events page</Link> and via email. </p>
                ...
                <p className="Faq-answer"> Yes, we have blocked rooms for Friday, April 22 and Saturday, April 23 at our venue, the Hyatt Regency Chesapeake Bay Golf Resort, and the Holiday Inn Express, Cambridge. You can use the <Link to="/travel" className="internal-link">travel page</Link> to get started.</p>

                <h3 className="Faq-question"> when does the hotel block close? </h3>
                <p className="Faq-answer"> The last day to book a room in our hotel block is March 9, 2022.</p>
